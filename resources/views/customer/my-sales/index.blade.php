                                    ...
                                    <tr class="tb-tnx-item">
                                        ...
                                        <td class="tb-tnx-amount is-alt">
                                            <div class="tb-tnx-total">
                                                <span class="amount"><em class="ni ni-sign-dollar"></em>{{ number_format($sale->price, 2) }}</span>
                                            </div>
                                            <div class="tb-tnx-status text-capitalize">
                                                <span class="badge badge-dot @if ($sale->status == 'sold')
                                                    bg-success @else bg-warning
                                                @endif">{{ $sale->status }}</span>
                                            </div>
                                        </td>
                                    </tr><!-- tb-tnx-item -->
                                    @endforeach
