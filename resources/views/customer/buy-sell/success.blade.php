                    ...
                    <div class="card card-bordered p-4 mt-5">
                        ...
                        <center>
                            <div class="nk-modal">
                                ...
                                <div class="nk-modal-text">
                                    <p class="caption-text">Your trade has been published into our sales-order database and {{ request()->session()->get('sell_amount') }} {{ request()->session()->get('crypto_abbr') }}
                                              has been deducted from your <span class="text-capitalize">{{ request()->session()->get('crypto') }}</span>
                                        wallet.</p>
                                </div>
                        ...
                        <center>
                            <div class="nk-modal">
                                ...
                                <div class="nk-modal-text">
                                    <p class="caption-text">Your trade has been submitted and will be published to our sales-order database once your payment is approved.</p>
                                </div>
                                <div class="nk-modal-action-lg">
                                    <ul class="btn-group gx-4">
                                        <li><a href="{{ route('customer.dashboard') }}"
