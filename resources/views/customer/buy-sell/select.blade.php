            ...
            <div class="components-preview wide-lg mx-auto">
                ...
                <div class="nk-block nk-block-lg">
                    <div class="card card-bordered">
                        <form class="nk-stepper stepper-init is-alter" action="{{ route('customer.buy-sell-select.post') }}" method="POST" id="stepper-two-factor-auth"
                                                ...
                                                <li class="col-xxl-2 col-lg-3 col-md-4 col-sm-6">
                                                    <div
                                                        ...
                                                        <input type="radio" class="custom-control-input"
                                                            name="tranx_coin" id="{{ $c->name }}" value="{{ $c->name }}-{{ $c->abbr }}"
                                                            required="">
                                                        <label class="custom-control-label" for="{{ $c->name }}">
                                                            <span class="d-flex flex-column text-center mt-5">
                                                                <span class="icon-wrap xl text-primary">
                                                                    <img src="{{ asset('uploads/'.$c->crypto_img) }}"
                                                                        alt="">
                                                                </span>
                                                                <span class="lead-text mb-1 mt-3 text-capitalize">{{ $c->name }}</span>
                                                            </span>
                                                        </label>
                                                    </div>
                                                </li>
