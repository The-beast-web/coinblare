                ...
                <div class="nk-block-head">
                    ...
                    <div class="nk-block-between-md g-4">
                        ...
                        <div class="nk-block-head-content">
                            ...
                            @if ($wallet->count() >= 1)
                            <a href="#withdraw" data-bs-toggle="modal" class="btn btn-outline-warning">Withdraw Crypto</a>
                            @endif
                        </div>
                ...
                <div class="nk-block">
                    ...
                    <div class="row g-gs">
                        @if ($wallet->count() < 1)
                            <div class="col-12">
                                <div class="card p-5">
                                    <h5 class="text-capitalize text-center" style="font-style: italic; font-family: Courier New;">No Wallets Yet!</h5>
                                    <p class="text-capitalize text-center text-white" style="font-style: italic;">Deposit or buy a cryptocurrency to automatically create a wallet.</p>
                                </div>
                            </div>
                        @else
                                    ...
                                    <div class="nk-wgw-inner">
                                        <a class="nk-wgw-name" href="html/crypto/wallet-bitcoin.html">
                                            <div class="nk-wgw-icon bg-transparent">
                                                <img src="{{ asset('uploads/' . $wall->wallet_symbol) }}" alt="">
                                            </div>
                                            <h5 class="nk-wgw-title title text-capitalize">{{ $wall->crypto_wallet }}
                                                Wallet</h5>
                                        </a>
                                        <div class="nk-wgw-balance">
                                            <div class="amount">{{ round($wall->balance_in_crypto, 3) }}<span
                                                    class="currency currency-btc">{{ $wall->abbr }}</span></div>
                                            <div class="amount-sm">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body modal-body-lg">
                        ...
                        <form action="{{ route('customer.wallets.deposit') }}" method="POST" id="withdraw-form" class="mt-4">
                            @csrf
                            <div class="buysell-field">
                                <div class="form-group">
                                    <div class="form-control-wrap">
