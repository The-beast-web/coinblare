                                    ...
                                    @foreach ($customer as $user)
                                        <div class="nk-tb-item">
                                            ...
                                            <div class="nk-tb-col tb-col-md">
                                                <div class="icon-text">
                                                    <span
                                                        class="sub-text">{{ number_format($user?->withdrawalable, 2) }}</span>
                                                </div>
                                            </div>
                                            <div class="nk-tb-col tb-col-lg">
                                                <span
                                                    class="tb-status text-capitalize @if ($user->status == 'active') text-success
                                        @else
                                            ...
                                            <div class="nk-tb-col nk-tb-col-tools">
                                                <ul class="nk-tb-actions gx-1">
                                                    ...
                                                    @if ($user->status == 'active')
                                                        <li class="nk-tb-action-hidden">
                                                            <a href="{{ route('admin.customers.suspend', $user->id) }}"
                                                                class="btn btn-trigger btn-icon" data-bs-toggle="tooltip"
                                                    ...
                                                    @else
                                                        <li class="nk-tb-action-hidden">
                                                            <a href="{{ route('admin.customers.reactive', $user->id) }}"
                                                                class="btn btn-trigger btn-icon" data-bs-toggle="tooltip"
                                                                data-bs-placement="top" title="Reactive">
                                                        ...
                                                        <div class="drodown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <ul class="link-list-opt no-bdr">
                                                                    <li><a
                                                                            href="{{ route('admin.customers.detail', $user->id) }}"><em
                                                                                class="icon ni ni-eye"></em><span>View
                                                                                Details</span></a></li>
                                                                    @if ($user->status == 'active')
                                                                        <li><a
                                                                                href="{{ route('admin.customers.suspend', $user->id) }}"><em
                                                                                    class="icon ni ni-cross-fill-c"></em><span>Suspend</span></a>
                                                                        </li>
                                                                    @else
                                                                        <li><a
                                                                                href="{{ route('admin.customers.reactive', $user->id) }}"><em
                                                                                    class="icon ni ni-check-circle-fill"></em><span>Reactive</span></a>
                                                                        </li>
                                                                    @endif
                                                                </ul>
                                                            </div>
