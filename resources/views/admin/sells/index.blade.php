                                ...
                                <div class="nk-tb-list nk-tb-ulist">
                                    <div class="nk-tb-item nk-tb-head">
                                        <div class="nk-tb-col nk-tb-col-check">
                                            <div class="custom-control custom-control-sm custom-checkbox notext">
                                                <input type="checkbox" class="custom-control-input" id="cid" @if ($tranx->count() < 1)
                                                    disabled
                                                @endif>
                                    ...
                                    @foreach ($tranx as $t)
                                        <div class="nk-tb-item">
                                            ...
                                            <div class="nk-tb-col tb-col-lg">
                                                <span
                                                    class="tb-status text-capitalize @if ($t->status == 'sold') text-success @endif @if ($t->status == 'published') text-warning @endif @if ($t->status == 'pending') text-danger @endif">{{ $t->status }}</span>
                                            </div>
                                                    ...
                                                    <ul class="nk-tb-actions gx-1">
                                                        @if ($t->status == 'pending')
                                                            <li class="nk-tb-action-hidden">
                                                                <a href="{{ route('admin.crypto.sells.approve', $t->id) }}"
                                                        ...
                                                        @if ($t->status == 'published')
                                                            <li class="nk-tb-action-hidden">
                                                                <a href="{{ route('admin.crypto.sells.buy', $t->id) }}"
                                                                    class="btn btn-trigger btn-icon"
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    title="Buy">
                                                            ...
                                                            <div class="drodown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li><a href="#"><em
                                                                                    class="icon ni ni-bag"></em><span>Buy</span></a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
