                ...
                <div class="nk-block-between">
                    <div class="nk-block-head-content">
                        ...
                        <div class="nk-block-des text-soft">
                            <p>You have total {{ $lang->count() }} language(s).</p>
                        </div>
                            ...
                            <div class="toggle-expand-content" data-content="pageMenu">
                                <ul class="nk-block-tools g-3">
                                    <li class="nk-block-tools-opt">
                                        <div class="drodown">
                                            <a href="{{ route('admin.lang.add') }}" data-bs-toggle="tooltip" title="Add Language" class="btn btn-icon btn-primary"><em class="icon ni ni-plus"></em></a>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="card-inner p-0">
                            <div class="nk-tb-list nk-tb-ulist">
                                <div class="nk-tb-item nk-tb-head">
                                    ...
                                    <div class="nk-tb-col tb-col-sm"><span class="sub-text">Universal Code</span></div>
                                ...
                                <div class="nk-tb-item">
                                    ...
                                    <div class="nk-tb-col">
                                        <a href="html/customer-details.html">
                                            <div class="user-card">
                                                <div class="user-name">
                                                    <span class="tb-lead text-capitalize">{{ $l->language_name }}</span>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="nk-tb-col tb-col-sm">
                                        <span class="sub-texttext-bold">{{ $l->lang_code }}</span>
                                    </div>
