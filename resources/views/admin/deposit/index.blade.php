                                            ...
                                            <div class="nk-tb-col nk-tb-col-tools">
                                                <ul class="nk-tb-actions gx-1">
                                                    ...
                                                    @if ($d->status == 'pending' || $d->status == 'declined')
                                                        <li class="nk-tb-action-hidden">
                                                            <a href="{{ route('admin.crypto-deposit.approve', $d->id) }}"
                                                                class="btn btn-trigger btn-icon" data-bs-toggle="tooltip"
                                                    ...
                                                    @if ($d->status == 'pending')
                                                        <li class="nk-tb-action-hidden">
                                                            <a href="{{ route('admin.crypto-deposit.decline', $d->id) }}"
                                                                class="btn btn-trigger btn-icon" data-bs-toggle="tooltip"
                                                                data-bs-placement="top" title="Decline">
                                                    ...
                                                    @if ($d->status == 'approved')
                                                        <li class="nk-tb-action-hidden">
                                                            <a href="{{ route('admin.crypto-deposit.cancel', $d->id) }}"
                                                                class="btn btn-trigger btn-icon" data-bs-toggle="tooltip"
                                                                data-bs-placement="top" title="Cancel Approval">
                                                        ...
                                                        <div class="drodown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <ul class="link-list-opt no-bdr">
                                                                    <li>
                                                                        <a
                                                                            href="{{ route('admin.crypto-deposit.detail', $d->id) }}">
                                                                            <em class="icon ni ni-eye-fill"></em>
                                                                            <span>View</span>
                                                                        </a>
                                                                    </li>
