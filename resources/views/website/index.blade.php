                        ...
                        <div class="header-wrap">
                            ...
                            <nav class="header-menu" data-content="mainNav">
                                <ul class="menu-list ms-lg-auto">
                                    ...
                                    <li class="menu-item"><a href="#feature" class="menu-link nav-link">Features</a></li>                                    <li class="menu-item"><a href="#reviews" class="menu-link nav-link">Reviews</a></li>
                                </ul>
                                <ul class="menu-btns">
                                    <li>
                                        <a href="#" target="_blank" class="btn btn-primary btn-lg"><em class="ni ni-user"></em>&nbsp;&nbsp;Login</a>
                                    </li>
                                </ul>
                            </nav><!-- .nk-nav-menu -->
                        </div><!-- .header-warp-->
                            ...
                            <div class="col-lg-5 col-md-10 mt-5">
                                <div class="header-caption mt-5">
                                    ...
                                    <div class="header-text">
                                        <p>Buy &amp; Sell more 20+ cryptocurrencies with our secure P2P platform. Use our easy-to-use crypto dashboard and aim high!</p>
                                    </div>
                                </div><!-- .header-caption -->
                            </div><!-- .col -->
                        </div><!-- .row -->
	...
	c1.5-2,1.6-4.7,0.2-6.8c-4.1-6.5-7.1-13.6-8.8-21.1c-0.5-2.4-2.4-4.3-4.8-4.7l-18.7-3L167.3,247.1z" />
			...
			c0-0.2,0-0.4,0-0.7C218.6,111.9,211.5,105,202.8,105.2z" />
                                        ...
                                        <div class="service-text">
                                            ...
                                            <p>We keep your money in escrow until a trade is completed successfully. So you don't have to worry about a scam trader.</p>
                                        </div>
                                    </div><!-- .service -->
                                </div>
                            </div><!-- .text-block -->
                        ...
                        <div class="col-xl-6 col-lg-7 col-md-8">
                            <div class="text-block is-compact">
                                ...
                                <ul class="btns-inline justify-center">
                                    <li>
                                        <a href="#" target="_blank" class="btn btn-xl btn-primary">Get Started.</a>
                                    </li>
                                </ul>
                            </div>
                        </div><!-- ,col -->
